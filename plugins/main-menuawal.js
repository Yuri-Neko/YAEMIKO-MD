...
let ᴛᴇs = `Powered By @${nomorwa.split`@`[0]}\nCreator By @${nomorown1.split`@`[0]}`
let wkwk = 'https://telegra.ph/file/1b773671be6d2f21f49d7.jpg'

conn.send2ButtonImg(m.chat, wkwk, knnt, ᴛᴇs, but1, id1, but2, id2, m, { contextInfo: { externalAdReply: { showAdAttribution: true,
    description: sgc,
