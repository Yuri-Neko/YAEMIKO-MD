...
let next = 'ɴ ᴇ x ᴛ'
let fot = botdate
let txtprem = '❗ ɴsғᴡ ɪɴɪ ᴋʜᴜsᴜs ᴜsᴇʀ ᴘʀᴇᴍɪᴜᴍ\nʜᴀʀᴀᴘ ʜᴜʙᴜɴɢɪ Owner ᴜɴᴛᴜᴋ ᴍᴇᴍʙᴇʟɪ ᴘʀᴇᴍɪᴜᴍ ! 📞'
let p = '🅟 | '
let f = 'Ⓕ | '
...
const sections = [
   {
	title: 'Silahkan Pilih Salah Satu Di Bawah',
	rows: [
...
case 'ahegao':
	    ...
	    if (!isPrems) return conn.sendButton(m.chat, txtprem, botdate, [['Beli Premium', '.premium'],['Owner', '.owner nomor']], m)
		}
