...
let name = conn.getName(who)
  conn.sendButton(m.chat, `Awas Anu Nya Berdiri Kak >,<`, wm, pickRandom(ometv), [['\nJadi Pengen Ngocok Batang :v', `huuu`]],m)
}
handler.help = ['asupanome']
handler.tags = ['asupan']
handler.command = /^(asupanome)$/i
