...
sendButtonDocAccess: {   
            ...
            async value (jid, content, footerText, button1, id1, quoted, options) {
              ...
              const buttonMessage = {
    document: { url: "https://wa.me/6281361281833" },
                mimetype: global.doc,
...
sendButtonDocUrl: {   
             ...
             * @param {Object} options 
             */
            async value (jid, content, footerText, distek, url, button1, id1, quoted, options) {
              const buttons = [{
  urlButton: {displayText: dtu, url: urlnya}, type: 1 }, { buttonId: id1, buttonText: { displayText: button1 }, type: 1 }
              ]
              const buttonMessage = {
    document: { url: "https://wa.me/6281361281833" },
                mimetype: global.doc,
                fileName: 'Tes Url Displays',
                fileLength: 999999999999999,
                pageCount: 1234567890123456789012345,
                caption: content,
                footer: footerText,
